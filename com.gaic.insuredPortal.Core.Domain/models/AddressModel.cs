...
namespace com.gaic.insuredPortal.Core.Domain.models
{
    public class AddressModel
    {
        ...
        {
            get { return String.Format("{0} {1}", FirstLine, LastLine).Trim(); }
        }
        ...
        private string ZipPlusFour
        {
            get
            {
                return String.IsNullOrEmpty(Zip4)
                    ...
                    : String.Format("{0}-{1}", String.IsNullOrEmpty(Zip) ? String.Empty : Zip,
                        String.IsNullOrEmpty(Zip4) ? String.Empty : Zip4).Trim();
            }
        }
    }
}